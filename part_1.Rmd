...
Firt, we load some packages. `tidyverse` is helpful for general data manipulation, while `sf` will give us access to some powerful mapping tools.
...
A simple evaluation statistic is the number of "competitive" districts based on some criteria. A common metric is looking at districts within 5 or 10% of 50%.
